        ...
        public void loadInterstitialAd() {
            if (adStatus.equals(AD_STATUS_ON) && placementStatus != 0) {
                switch (adNetwork) {
                    ...
                    case ALIEN:
                    case ALIEN_ADS:
                        PropsAdsManagement.loadInterstitialAds(activity, alienAdsInterstitialId, new InterstitialAdLoadCallback() {
                            @Override
                            public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                                super.onAdFailedToLoad(loadAdError);
                                loadBackupInterstitialAd();
                                Log.d(TAG, "Failed load Alien Interstitial Ad");

                            }
                            @Override
                            public void onAdLoaded(@NonNull com.google.android.gms.ads.interstitial.InterstitialAd interstitialAdProps) {
                                super.onAdLoaded(interstitialAdProps);
                                Log.d(TAG, "Alien Interstitial Ad Loaded");
                            }
                        });
                        break;
                    ...
                    switch (adNetwork) {
                        ...
                        case ALIEN_ADS:
                            if (PropsAdsManagement.getInterstitialAds() != null) {
                                ...
                                loadInterstitialAd();
                                Log.d(TAG, "Alien Ads Interstitial not null");
                            } else {
                                showBackupInterstitialAd();
                                Log.d(TAG, "Alien Ads Interstitial null");
                            }
                            break;
