...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadBannerAd() {
        bannerAd = new BannerAd.Builder(this)
                ...
                .setAlienAdsBannerId(Constant.ALIEN_BANNER_ID)
    ...
    private void loadInterstitialAd() {
        interstitialAd = new InterstitialAd.Builder(this)
                ...
                .setAlienAdsInterstitialId(Constant.ALIEN_INTERSTITIAL_ID)
    ...
    private void loadRewardedAd() {
        rewardedAd = new RewardedAd.Builder(this)
                ...
                .setAlienAdsRewardedId(Constant.ALIEN_REWARDED_ID)
    ...
    private void loadNativeAd() {
        nativeAd = new NativeAd.Builder(this)
                ...
                .setAlienAdsNativeId(Constant.ALIEN_NATIVE_ID)
    ...
    private void showAdChooser() {
        final String[] ads = {"AdMob", "Google Ad Manager", "Alien Ads"};
