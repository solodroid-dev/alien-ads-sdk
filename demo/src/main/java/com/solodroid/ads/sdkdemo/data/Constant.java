...
public class Constant {
    ...
    public static String AD_NETWORK = "alien";
    ...
    public static final String ALIEN_BANNER_ID = "testing";
    public static final String ALIEN_INTERSTITIAL_ID = "testing";
    public static final String ALIEN_REWARDED_ID = "testing";
    public static final String ALIEN_NATIVE_ID = "testing";
    public static final String ALIEN_APP_OPEN_AD_ID = "testing";
